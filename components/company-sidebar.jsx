...
const navigationItems = [
  ...
  },
  {
    title: "Onboarding",
    titleDa: "Onboarding",
    url: "/dashboard/company/onboarding",
    icon: FileCheck,
  },
  {
    title: "Active Interns",
    titleDa: "Aktive Praktikanter",
    url: "/dashboard/company/active-interns",
    icon: Briefcase,
  },
  {
    title: "Settings",
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              ...
              <DropdownMenuContent
                ...
                sideOffset={4}
              >
                <DropdownMenuItem onClick={() => router.push(`/${locale}/dashboard/company/profile`)} className="text-base py-2.5">
                  <UserCircle className="size-5 mr-2" />
                  {locale === "da" ? "Profil" : "Profile"}
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => router.push(`/${locale}/dashboard/company/settings`)} className="text-base py-2.5">
