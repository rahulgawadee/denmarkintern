...
export default function CheatSheetSection({ cheatSheet }) {
  ...
  return (
    <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-20 sm:py-24 bg-[#fdf5e6]">
      <h2 className="text-3xl sm:text-4xl font-bold text-[#4a3728] mb-8">{cheatSheet.title}</h2>
