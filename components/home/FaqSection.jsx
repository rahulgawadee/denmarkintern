export default function FaqSection({ items }) {
  ...
  return (
    <section id="faq" className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-20 sm:py-24 bg-[#ffefd5]">
      <h2 className="text-3xl sm:text-4xl font-bold text-[#4a3728] mb-12">FAQ</h2>
